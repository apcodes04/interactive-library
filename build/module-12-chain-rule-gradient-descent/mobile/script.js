(function () {
  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const STAGES = [
      {
        step: 0,
        explain: "Initial computational graph for x = 3. Tap Forward or Step 1.",
        fwd: {},
        bwd: {},
        legend: []
      },
      {
        step: 1,
        explain: "Forward Pass (Step 1): Input value x = 3 entered.",
        fwd: { x: 3 },
        bwd: {},
        legend: [{ label: "Forward Pass", color: "var(--primary)" }]
      },
      {
        step: 2,
        explain: "Forward Pass (Step 2): Node f(x) = 2 * 3 = 6.",
        fwd: { x: 3, f: 6 },
        bwd: {},
        legend: [{ label: "Forward Pass", color: "var(--primary)" }]
      },
      {
        step: 3,
        explain: "Forward Pass (Step 3): Node g(f) = 6² = 36.",
        fwd: { x: 3, f: 6, g: 36 },
        bwd: {},
        legend: [{ label: "Forward Pass", color: "var(--primary)" }]
      },
      {
        step: 4,
        explain: "Forward Pass (Step 4): Loss = 36 evaluated.",
      ...
      {
        step: 5,
        explain: "Backward Pass (Step 5): dLoss/dg = 1.",
        fwd: { x: 3, f: 6, g: 36, loss: 36 },
        bwd: { g: "dLoss/dg = 1" },
        legend: [{ label: "Forward Pass", color: "var(--primary)" }, { label: "Gradient", color: "var(--active)" }]
      },
      {
        step: 6,
        explain: "Backward Pass (Step 6): dLoss/df = 1 * (2 * 6) = 12.",
        fwd: { x: 3, f: 6, g: 36, loss: 36 },
      ...
      {
        step: 7,
        explain: "Backward Pass (Step 7): dLoss/dx = 12 * 2 = 24.",
        fwd: { x: 3, f: 6, g: 36, loss: 36 },
