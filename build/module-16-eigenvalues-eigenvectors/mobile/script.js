(function () {
  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const transformedPath = svg.append('path').attr('fill', 'rgba(79, 70, 229, 0.15)').attr('stroke', 'var(--primary)').attr('stroke-width', 2);
    ...
    function update() {
      ...
      if (disc < 0) {
        ...
        document.getElementById('explainPanel').textContent = "Complex eigenvalues — matrix rotates space.";
      } else {
        ...
        document.getElementById('explainPanel').textContent =
          `λ1 = ${l1.toFixed(2)}, λ2 = ${l2.toFixed(2)}. Eigenvector axes stretch by λ.`;
      }
