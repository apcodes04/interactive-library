  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const DATA = {
      2021: {
        ...
        benchmark: 52,
        explain: "2021: InstructGPT introduced RLHF alignment over baseline GPT-3 with a 4,096-token context window and ~52% MMLU accuracy."
      },
      2022: {
        ...
        modality: "Text + Code",
        benchmark: 70,
        explain: "2022: ChatGPT expanded conversational capabilities and code execution, extending context to 16K tokens with MMLU reaching ~70%."
      },
      2023: {
        ...
        benchmark: 86,
        explain: "2023: GPT-4 launched multimodal image processing and expanded context to 128K tokens, hitting an 86.4% MMLU benchmark score."
      },
      2024: {
        ...
        benchmark: 89,
        explain: "2024: GPT-4o unified real-time audio/vision modalities natively, paired with OpenAI o1 chain-of-thought reasoning models (88.7% MMLU)."
      },
      2025: {
        ...
        benchmark: 91,
        explain: "2025: GPT-4.5 introduced massive 1-million-token context windows for entire codebase analysis, pushing MMLU past 90.8%."
      },
      2026: {
        ...
        benchmark: 94,
        explain: "2026: Frontier GPT-5 architectures combine 1M+ token context with autonomous agentic tools and 93.5%+ benchmark saturation."
      }
    };
